...
The app is hosted on **Netlify** as **ESA AI** at https://esa-ai-personal-assistant.netlify.app. Manual deploys for now — no CI/CD. Firebase (Auth + Firestore) is the backend and is deployed separately with the Firebase CLI.
